...
from chatbot.tools import fetch_case_history
...
monitoring_agent = Agent(
    ...
    tools=[fetch_case_history, AgentTool(sore_throat_specialist_agent)], 
    instruction="""
    You are the **Medical Follow-up Monitor**, a specialized sub-agent responsible for post-consultation triage.
      ...
      - This information will be stored in `patient_case_context` state. You can reference this context at any time during the conversation to ground your responses and tool calls.
      ...
      **Option C: WORSENED / NEW SYMPTOMS (Risk)**
      ...
      - **Tool Call**: `delegate_agent(target_agent="sore_throat_specialist", mode="re_evaluation", payload={new_symptoms})`
